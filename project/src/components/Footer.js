      ...
      <div className="footer_block">
        <div className="footer_block_text">
          ...
          <span className="footer_block_text_txt">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla faucibus egestas elit, at
        ...
        <div className="footer_block_links">
          ...
          <ul className="footer_block_list">
            ...
            <li className="footer_block_list_el">
              <span>
                <i className="fab fa-vk footer_block_list_el_icon"></i> VK.com
              </span>
            </li>
            <li className="footer_block_list_el">
              <span>
                <i className="fab fa-facebook-square footer_block_list_el_icon"></i> Facebook
              </span>
            </li>
            <li className="footer_block_list_el">
              <span>
                <i className="fab fa-instagram footer_block_list_el_icon"></i> Instagram
              </span>
            </li>
          </ul>
        </div>
